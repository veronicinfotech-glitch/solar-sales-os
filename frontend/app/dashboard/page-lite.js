  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Dashboard (Lite)</h1>
          <p className="mt-2 text-slate-600">
            Lightweight overview. No charts. Raw numbers only.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <p className="text-sm font-medium text-slate-500">Hot</p>
            <h2 className="mt-2 text-2xl font-bold text-red-500">{stats.hot}</h2>
          </div>
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <p className="text-sm font-medium text-slate-500">Warm</p>
            <h2 className="mt-2 text-2xl font-bold text-amber-500">{stats.warm}</h2>
          </div>
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <p className="text-sm font-medium text-slate-500">Cold</p>
            <h2 className="mt-2 text-2xl font-bold text-slate-400">{stats.cold}</h2>
          </div>
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <p className="text-sm font-medium text-slate-500">Overdue Calls</p>
            <h2 className="mt-2 text-2xl font-bold text-red-600">{stats.overdueCalls}</h2>
          </div>
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
            <p className="text-sm font-medium text-slate-500">Today&apos;s Surveys</p>
            <h2 className="mt-2 text-2xl font-bold text-cyan-600">{stats.todaySurveys}</h2>
          </div>
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
